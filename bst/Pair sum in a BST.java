...
public static int countNodes (BinaryTreeNode<Integer> root) {
    ...
    public static void printNodes SumToS (BinaryTreeNode<Integer> root, int s) {
      if(root == null) {
        return;
      }
    ...
    while(count < totalCount -1) {
      BinaryTreeNode<Integer> topl= inorder.peek();
      BinaryTreeNode<Integer> top2 = revInorder.peek();
      if (topl.data + top2.data == s) 
      { System.out.println(topl.data + " " + top2.data);
      ...
      BinaryTreeNode<Integer> top=topl;
      inorder.pop();
      count++;
      if (top.right != null) {
        top= top.right; 
